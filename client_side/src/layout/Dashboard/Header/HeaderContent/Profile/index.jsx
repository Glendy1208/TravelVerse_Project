...
export default function Profile() {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await API.get("/getUsers"); // Panggil API langsung
                        ...
                        <Stack direction="row" sx={{ gap: 1.25, alignItems: 'center' }}>
                          ...
                          <Stack>
                            ...
                            <Typography variant="body2" color="text.secondary">
                              { data.user_category_id == '2' ? 'Operator' : 'Admin' }
                            </Typography>
                          </Stack>
                        </Stack>
                      </Grid>
...
TabPanel.propTypes = { children: PropTypes.node, value: PropTypes.number, index: PropTypes.number, other: PropTypes.any, handleLogout: PropTypes.func };
